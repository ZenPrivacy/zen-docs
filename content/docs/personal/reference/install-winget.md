...
To install Zen, run the following command:

```powershell
winget install -e --id ZenPrivacy.ZenDesktop
```

## See also

- [WinGet package manifest](https://github.com/microsoft/winget-pkgs/tree/master/manifests/z/ZenPrivacy/ZenDesktop)
